...
<div align="center">
  <img src="../images/main-features.png" alt="Основной функционал" width="600"/>
  <p><em>Основной функционал и цветной вывод</em></p>
</div>

<div align="center">
  <img src="../images/language-switching.png" alt="Переключение языков" width="600"/>
  <p><em>Поддержка нескольких языков с русским и английским</em></p>
</div>

<div align="center">
  <img src="../images/search-functionality.png" alt="Функция поиска" width="600"/>
  <p><em>Продвинутый поиск по всем шпаргалкам</em></p>
</div>

*📸 [Посмотреть все скриншоты](../images/README.md) | [Руководство по скриншотам](../images/README.md#guidelines-for-screenshots)*
