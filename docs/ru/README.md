...
### v1.7.0 - Таблица статуса и планирование будущего
- ✅ Добавлена подробная таблица статуса, показывающая все шпаргалки и языки
- ✅ Добавлена поддержка будущих языков: Немецкий (Deutsch), Французский (Français), Испанский (Español)
- ✅ Запланированы дополнительные шпаргалки: tar, awk, sed, cron, netstat, lsof, nmap, ufw, make, package managers
- ✅ Улучшена документация проекта с четкой дорожной картой разработки

### v1.6.0 - Новые темы и улучшения
- ✅ Добавлена подробная шпаргалка по команде **find**
- ✅ Добавлены шпаргалки **tmux**, **htop**, **curl**, **ssh**
- ✅ Исправлены дублирующиеся ключи переводов в шаблонах htop
- ✅ Улучшено форматирование шаблонов с правильными переносами строк
- ✅ Улучшена функция поиска с группировкой по темам
- ✅ Оптимизирована производительность поиска переводов

### v1.5.0 - Поддержка Systemctl
- ✅ Добавлена шпаргалка по команде **systemctl**
- ✅ Улучшена функция поиска для включения новых тем

### v1.4.x - Поиск и пагинация
- ✅ Исправлена функция поиска для отображения команд с описаниями
- ✅ Добавлен цветной вывод в результатах поиска
- ✅ Оптимизирована производительность для больших шпаргалок
